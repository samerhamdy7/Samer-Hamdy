        ...
        <div className="mx-auto max-w-4xl rounded-xl sm:rounded-2xl md:rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 sm:p-8 md:p-10 shadow-2xl shadow-slate-950/40 backdrop-blur-xl">
          <div className="space-y-6 text-center">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="show"
              className="text-center text-lg sm:text-xl md:text-2xl font-semibold text-sky-300"
            >
              <TypeAnimation
                sequence={[
            ...
            <motion.p
              ...
              initial="hidden"
              animate="show"
              className="mx-auto max-w-2xl text-sm sm:text-base md:text-lg text-slate-300"
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="show"
              className="flex flex-col gap-3 sm:gap-4 sm:flex-row items-center justify-center"
            >
              <a
                href="#work"
              ...
              <a
                href="#contact"
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-full border border-white/10 bg-white/5 px-6 sm:px-8 py-3 text-xs sm:text-sm font-semibold text-slate-100 transition hover:border-blue-400 hover:text-blue-300"
              >
                Let’s collaborate
              </a>
            </motion.div>
            <motion.div
              ...
              initial="hidden"
              animate="show"
              className="mt-8 sm:mt-10 grid gap-2 sm:gap-3 grid-cols-2 sm:grid-cols-4"
            >
              {["Next.js", "Laravel", "Python", "Tailwind"].map((skill) => (
                <span
                  key={skill}
                  className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-xs sm:text-sm text-slate-200 text-center"
                >
                  {skill}
                </span>
              ))}
